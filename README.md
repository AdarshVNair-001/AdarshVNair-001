...
<p align="center">
I’m a passionate developer who enjoys building modern web applications and creating clean, user-friendly interfaces. I'm continuously expanding my knowledge through hands-on projects and exploring both frontend and backend development.
</p>

<h3 align="left">About Me</h3>

- 🧑‍💻 Aspiring Full Stack Developer with a strong interest in modern web technologies
- 🌐 Skilled in building responsive and interactive web applications
- ⚡ Experience with HTML, CSS, JavaScript, TypeScript, Angular,ADO.NET and ASP.NET Core MVC
- 💾 Familiar with C, C#, C++, Java, Python, SQL, Entity Framework Core, and REST APIs
...
- 📚 Continuously learning new technologies by building real-world projects

<h3 align="left">Projects</h3>

- Full Stack E-Commerce Website using ASP.NET Core MVC
- Responsive frontend applications built with HTML, CSS, JavaScript, and Angular
- UI/UX design prototypes created using Figma
- Python-based learning and automation projects
- Academic projects involving AI, machine learning, and web technologies
